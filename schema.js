const corrections = {
  // What to capitalize
  newRelic: ["New Relic", "we"],
  newRelicOne: ["New Relic One", "New Relic One platform"],
  futureStack: ["FutureStack", "{Future}Stack"],
  codeStream: ["CodeStream", "New Relic CodeStream"],
  explorer: ["Explorer", "New Relic Explorer"],
  ...
  lookout: ["New Relic Lookout", "Lookout"],
  lookout: ["New Relic Navigator", "Navigator"],

  // What not to capitalize
  apm: ["application performance monitoring", "application monitoring", "APM"],
  pixie: [
  ...
  logManagement: ["log management", "logs"],
  melt: [
